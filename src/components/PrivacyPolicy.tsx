...
export default function PrivacyPolicy() {
  return (
    <>
      <SEO 
        title="Privacy Policy - Cabos Handyman"
        description="Privacy policy for Cabos Handyman services in Cabo San Lucas. Learn how we protect your personal information."
