...
export default function TermsOfService() {
  return (
    <>
      <SEO 
        title="Terms of Service - Cabos Handyman"
        description="Terms of service for Cabos Handyman. Professional handyman and construction services in Cabo San Lucas, Mexico."
        canonicalUrl="/terms"
      />
