        ...
        <div className="grid md:grid-cols-4 gap-8 text-sm">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex items-center space-x-2 text-gray-600">
                <svg className="h-4 w-4 text-teal-400" viewBox="0 0 24 24" fill="currentColor"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.69a8.18 8.18 0 0 0 4.78 1.52V6.75a4.85 4.85 0 0 1-1.01-.06z"/></svg>
                <a href="https://www.tiktok.com/@caboshandyman" target="_blank" rel="noopener noreferrer" className="hover:text-teal-500 transition-colors">
                  TikTok
                </a>
              </div>
