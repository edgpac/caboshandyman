...
async function analyzeWithGroq(description, visionAnnotations = {}, serviceContext = null) {
  try {
    ...
    const prompt = `You are an expert contractor cost estimator for Cabo San Lucas, Mexico. Analyze this maintenance/construction project and provide realistic 2024-2025 pricing.
...
PRICING FACTORS:
- Cabo San Lucas pricing (includes import costs for specialized materials)
...
Base your estimates on REAL MARKET CONDITIONS for Cabo San Lucas, Mexico in 2024-2025. Consider the complexity, materials needed, and current construction costs.`;
...
function getDefaultStores() {
  return [
    {
      name: "Home Depot Cabo San Lucas",
      address: "Carretera Transpeninsular Benito Juárez Km 6.5, Cabo Bello, 23410 Cabo San Lucas, B.C.S., Mexico",
      rating: 4.2
    },
    {
      name: "Ace Hardware Los Cabos", 
      address: "Cabo San Lucas, B.C.S., Mexico",
      rating: 4.1
    },
    {
